...
<%
		...
		String[] StudentName = {"Priyansh","amit","Faiz","Imran","Rohit"};
...
if(flag.length >=1 )
{
	out.println("Students Attendance Added Successfully!!!");
}

else
{
	out.println("Students Attendance Not Added Please try again!!!!");
}
%>
</body>
</html>